...
urlpatterns = [
    ...
    url(r'^manage/quantpolicy/add/$', login_required(addDuiqiaoView.as_view()), name='manage_addduiqiao'),
    url(r'^manage/quantpolicy/(?P<pk>[0-9]+)/update/$', login_required(updateDuiqiaoView.as_view()), name='manage_updateduiqiao'),
    url(r'manage/quantpolicy/(?P<pk>[0-9]+)/delete/$', login_required(deleteDuiqiaoView.as_view()), name='manage_deleteduiqiao'),
    url(r'^manage/quantpolicy/(?P<pk>[0-9]+)/$', login_required(getDuiqiaoDetailView.as_view()), name='manage_getduiqiao'),
