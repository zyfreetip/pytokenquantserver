...
class BtcBlockModel(PermissionsMixin):
    ...
    mrkl_root = models.CharField(max_length=256, verbose_name='Merkle Root', default='')
    ...
    hash = models.CharField(max_length=256, verbose_name='快哈希')
    prev_block_hash = models.CharField(max_length=256, verbose_name='前向区块哈希')
    next_block_hash = models.CharField(max_length=256, verbose_name='后向区块哈希')
    ...
    relayed_by = models.CharField(max_length=256, verbose_name='块播报方')
...
class BtcTransactionModel(PermissionsMixin):
    ...
    txhash = models.CharField(max_length=256, primary_key=True)
...
class BtcInputTransactionModel(PermissionsMixin):
    ...
    txhash = models.CharField(max_length=256, verbose_name='交易hash')
    prev_address = models.CharField(max_length=256, verbose_name='输入地址')
    ...
    script_asm = models.CharField(verbose_name='asm脚本', max_length=256)
    script_hex = models.CharField(verbose_name='hex脚本', max_length=256)
...
class BtcOutputTransactionModel(PermissionsMixin):
    ...
    id = models.BigAutoField(primary_key=True)
    txhash = models.CharField(max_length=256, verbose_name='交易hash')
    address = models.CharField(max_length=256, verbose_name='输出地址')
