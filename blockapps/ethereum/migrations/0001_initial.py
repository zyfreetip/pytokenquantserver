    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input', models.CharField(default='', max_length=255, verbose_name='交易发送的数据')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='记录创建时间')),
            ],
            options={
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_address', models.CharField(default='', max_length=200, verbose_name='合约地址')),
                ('root', models.CharField(default='', max_length=200, verbose_name='拜占庭交易状态根')),
