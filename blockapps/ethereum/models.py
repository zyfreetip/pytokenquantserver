...
class EthereumBlockModel(PermissionsMixin):
    ...
    difficulty = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='该区块难度', default=0)
    total_difficulty = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='区块累计总难度', default=0)
...
class EthereumAddressModel(PermissionsMixin):
    ...
    received = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='总接收数量', default=0)
    sent = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='总支出数量', default=0)
    balance = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='当前余额', default=0)
...
class EthereumTransactionModel(PermissionsMixin):
    ...
    value = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='交易金额Wei', default=0)
    gas_price = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='gas价格', default=0)
...
class EthereumTransactionReceiptModel(PermissionsMixin):
    ...
    block_hash = models.CharField(max_length=255, verbose_name='区块哈希', default='')
    block_number = models.BigIntegerField(verbose_name='区块高度', default=0)
    total_gas = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='区块gas使用总量', default=0)
    gas_used = models.DecimalField(max_digits=40, decimal_places=0, verbose_name='该交易使用gas量', default=0)
