    ...
    def getBlockData(self, ctx):
        ...
        for ico_name in ico_names:
            ...
            if icoStats: 
                ...
                median_confirmation_time.update({ico_name['ico_name']: icoStats[0].median_confirmation_time.strftime('%Y-%m-%d')})
    ...
    def getBlockBasicInfo(self, ctx):
        ...
        for ico_name in ico_names:
            ...
            if icoStats: 
                ...
                first_block_time.update({ico_name['ico_name']: icoStats[0].first_block_time.strftime('%Y-%m-%d')})
    ...
    def getBlockMediaInfo(self, ctx):
        ...
        for ico_name in ico_names:
            ...
            if icoGithub:
                ...
                project_update_time.update({ico_name['ico_name']: icoGithub[0].project_update_time.strftime('%Y-%m-%d')})
