...
class icoInfo(object):
    ...
    def getBlockData(self, ctx):
        ...
        median_confirmation_time.update({'cn_name': IcoStatsModel._meta.get_field('median_confirmation_time').verbose_name.strftime('%Y-%m-%d')})
    ...
    def getBlockBasicInfo(self, ctx):
        ...
        first_block_time.update({'cn_name': IcoBasicInfoModel._meta.get_field('first_block_time').verbose_name.strftime('%Y-%m-%d')})
    ...
    def getBlockMediaInfo(self, ctx):
        ...
        project_update_time.update({'cn_name': IcoGithubStatsModel._meta.get_field('project_update_time').verbose_name.strftime('%Y-%m-%d')})
