...
class IcoStatsModel(PermissionsMixin):
    ...
    address_richer_than_1usd = models.BigIntegerField(verbose_name='金额超过1usd钱包地址百分比', default=0)
    address_richer_than_100usd = models.BigIntegerField(verbose_name='金额超过100usd钱包地址百分比', default=0)
    address_richer_than_1000usd = models.BigIntegerField(verbose_name='金额超过1000usd钱包地址百分比', default=0)
    address_richer_than_10000usd = models.BigIntegerField(verbose_name='金额超过10000usd钱包地址百分比', default=0)
