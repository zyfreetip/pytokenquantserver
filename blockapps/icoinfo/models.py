...
class IcoGithubStatsModel(PermissionsMixin):
    ...
    stars = models.IntegerField(verbose_name='stars数(个)', default=0)
    stars_incr_week = models.IntegerField(verbose_name='本周新增星数(个)', default=0)
    commits_this_month = models.IntegerField(verbose_name='近一个月提交次数(次)', default=0)
    commits_last_week = models.IntegerField(verbose_name='上周提交次数(次)', default=0)
    commits_this_week = models.IntegerField(verbose_name='本周提交次数(次)', default=0)
    ...
    branches = models.IntegerField(verbose_name='分支数(个)', default=0)
    forks = models.IntegerField(verbose_name='fork数(个)', default=0)
    issues = models.IntegerField(verbose_name='问题数(个)', default=0)
    watchers = models.IntegerField(verbose_name='关注数(个)', default=0)
    projects = models.TextField(verbose_name='项目库(个)', default='')
...
class IcoExchangesStatsModel(PermissionsMixin):
    ...
    ico_name = models.CharField(max_length=255, verbose_name='项目名称', default='')
    token = models.CharField(max_length=255, verbose_name='项目代号', default='')
    fair_price = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='公允价格(美元)', default=0)
    change_24h = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='24小时变化百分比', default=0)
    circulating_supply = models.BigIntegerField(verbose_name='已供应币数(个)', default=0)
    max_supply = models.BigIntegerField(verbose_name='总供应币数(个)', default=0)
    market_capitalization = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='市值(美元)', default=0)
    transactions_last_24h = models.BigIntegerField(verbose_name='24小时交易量(美元)', default=0)
    total_trade_volume_24h = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='24小时交易所成交总额(美元)', default=0)    
...
class IcoStatsModel(PermissionsMixin):
    ...
    ico_name = models.CharField(max_length=255, verbose_name='项目名称', default='')
    token = models.CharField(max_length=255, verbose_name='项目代号', default='')
    transactions_number_day = models.BigIntegerField(verbose_name='当日总交易次数(次)', default=0)
    transactions_number_hour = models.BigIntegerField(verbose_name='小时总交易次数(次)', default=0)
    total_transactions_fees = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='当日总交易费(美元)', default=0)
    avg_transactions_value = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='交易价值均值(美元)', default=0)
    meidan_transactions_value = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='交易价值中位数(美元)', default=0)
    total_output_value = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='当日总交易传出量(美元)', default=0)
    assets_turnover_rate = models.DecimalField(max_digits=40, decimal_places=5, verbose_name='资产中转率', default=0)
    actual_tps = models.BigIntegerField(verbose_name='实际每秒交易量(笔)', default=0)
    ...
    mempool_size = models.BigIntegerField(verbose_name='未确认交易数量(个)', default=0)
    current_best_transaction_fees = models.DecimalField(verbose_name='最佳交易费用(美元)', max_digits=40, decimal_places=5, default=0)
    blocks_last_24h = models.BigIntegerField(verbose_name='24小时生成区块数(个)', default=0)
    blocks_avg_perhour = models.BigIntegerField(verbose_name='每小时生成区块数(个)', default=0)
    ...
    blocks_mined_day = models.CharField(verbose_name='当天挖出区块(个)', max_length=255, default='')
    bitcoins_mined_total = models.CharField(verbose_name='累计挖出比特币数量(个)', max_length=255, default='')
    block_count = models.BigIntegerField(verbose_name='区块总数(个)',  default=0)
    block_pre_reward = models.DecimalField(verbose_name='当前区块奖励(美元)', max_digits=40, decimal_places=5, default=0)
    reward_last_24h = models.DecimalField(verbose_name='24小时区块奖励数(美元)', max_digits=40, decimal_places=5, default=0)
    top_100_richest = models.BigIntegerField(verbose_name='财富top100地址总金额(美元)', default=0)
    wealth_distribution_top10 = models.BigIntegerField(verbose_name='财富top10地址所占金额百分比', default=0)
    wealth_distribution_top100 = models.BigIntegerField(verbose_name='财富top100地址所占金额百分比', default=0)
    wealth_distribution_top1000 = models.BigIntegerField(verbose_name='财富top1000地址所占金额百分比', default=0)
    wealth_distribution_top10000 = models.BigIntegerField(verbose_name='财富top10000地址所占金额百分比', default=0)
    address_richer_than_1usd = models.BigIntegerField(verbose_name='金额超过1usd钱包地址数(个)', default=0)
    address_richer_than_100usd = models.BigIntegerField(verbose_name='金额超过100usd钱包地址数(个)', default=0)
    address_richer_than_1000usd = models.BigIntegerField(verbose_name='金额超过1000usd钱包地址数(个)', default=0)
    address_richer_than_10000usd = models.BigIntegerField(verbose_name='金额超过10000usd钱包地址数(个)', default=0)
    active_addresses_last24h = models.BigIntegerField(verbose_name='过去24小时活跃地址数(个)', default=0)
    new_addresses_last24h = models.BigIntegerField(verbose_name='过去24小时新建地址数(个)', default=0)
    transaction_largest100 = models.BigIntegerField(verbose_name='24小时最大100笔交易总金额(美元)', default=0)
    mining_pro = models.CharField(verbose_name='24小时矿工收入(美元)', max_length=255, default='')
    transactions_fees = models.CharField(verbose_name='24小时交易费用百分比', max_length=255, default='')
    per_transactions_volume = models.CharField(verbose_name='24小时矿工收入/交易量', max_length=255, default='')
